...
///
- (nullable instancetype)initWithDescription:(NSString * _Nonnull)description currency:(NSString * _Nonnull)currency publicHash:(NSString * _Nonnull)publicHash toIban:(NSString * _Nonnull)toIban emailNotification:(BOOL)emailNotification sum:(NSDecimal)sum identifier:(NSString * _Nonnull)identifier identifierType:(enum IPUIIdentifierType)identifierType ultimateDebtor:(NSString * _Nonnull)ultimateDebtor error:(NSError * _Nullable * _Nullable)error OBJC_DESIGNATED_INITIALIZER;
...
/// Starts a payment flow with an IBAN picker for the sender’s accounts.
/// If you have a webhook hash you can provide it, so your webhook will be notified when the process finishes.
/// \param hookHash The hash for your webhook. Default value is <code>nil</code>. This parameter is optional.
///
- (void)createPayWithBankAccountWithHookHash:(NSString * _Nullable)webhookHash delegate:(id <IPUIPaymentDelegate> _Nonnull)delegate;
...
/// \param country If provided only banks from that country will be shown. Default value is <code>.all</code>.
///
/// \param bankHashes An array of bank hashes of the banks you’d want to show in the list. Default is an empty array which shows all banks.
///
/// \param hookHash The hash for your webhook. Default value is <code>nil</code>. This parameter is optional.
///
/// \param ibanHookHash Default value is <code>nil</code>. This parameter is optional.
